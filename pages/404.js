    ...
    <div className="relative text-white bg-primary font-poppins w-screen h-screen overflow-x-hidden">
      <div className="max-w-[1440px] m-auto w-full">
        <div className="flex flex-col items-center z-50">
          ...
          <h1 className="text-[43px] lg:text-[56px] text-gradient font-bold -translate-y-16">
            Page Not Found
          </h1>
          <p className="text-[18px] lg:text-[23px] text-center -translate-y-12">
        ...
        <div className="fixed left-[300px] lg:left-[432px] top-[97px] animate-pulse fof__particle1">
          <Image src={blurGradientEllipse} alt="" width="44px" height="44px" />
        </div>
        <div className="fixed left-[20px] lg:left-[1034px] top-[400px] lg:top-[306px] fof__particle2">
          <Image
            src={normalGradientEllipse}
            alt=""
            width="78px"
        ...
        <div className="fixed left-[326px] top-[450px] lg:top-[506px] animate-pulse fof__particle3">
          <Image
            src={normalGradientEllipse}
            alt=""
            width="44px"
        ...
        <div className="fixed left-[850px] top-[550px] fof__particle4">
